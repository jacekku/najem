...
class AccountingSchemaShapeTest {
    ...
    private static final List<String> EXPECTED_COLUMNS = List.of(
        ...
        "acc_deposit.deducted_amount numeric null",
        ...
        "acc_deposit.rent_at_return numeric null",
        "acc_deposit.returned_amount numeric null",
        "acc_deposit.settled_on date null",
        "acc_deposit.state text not null",
        "acc_deposit.tenancy_id uuid not null",
        "acc_deposit.valorized_amount numeric null",
        "acc_deposit.workspace_id uuid not null",
        "acc_deposit_deduction.amount numeric not null",
        "acc_deposit_deduction.charge_id uuid not null",
        "acc_deposit_deduction.deducted_on date not null",
        "acc_deposit_deduction.deduction_id uuid not null",
        "acc_deposit_deduction.deposit_id uuid not null",
        "acc_deposit_deduction.workspace_id uuid not null",
    ...
    private static final List<String> EXPECTED_CONSTRAINTS = List.of(
        ...
        "acc_deposit_deduction acc_deposit_deduction_charge_id_fkey FOREIGN KEY (charge_id) REFERENCES acc_charge(charge_id)",
        "acc_deposit_deduction acc_deposit_deduction_deposit_id_fkey FOREIGN KEY (deposit_id) REFERENCES acc_deposit(deposit_id)",
        "acc_deposit_deduction acc_deposit_deduction_pkey PRIMARY KEY (deduction_id)",
    ...
    private static final List<String> EXPECTED_INDEXES = List.of(
        ...
        "acc_deposit_deduction acc_deposit_deduction_deposit_idx CREATE INDEX acc_deposit_deduction_deposit_idx ON acc_deposit_deduction USING btree (workspace_id, deposit_id)",
        "acc_deposit_deduction acc_deposit_deduction_pkey CREATE UNIQUE INDEX acc_deposit_deduction_pkey ON acc_deposit_deduction USING btree (deduction_id)",
