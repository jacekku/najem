...
public class RetentionController {
    ...
    public void setHold(@ActingWorkspace UUID workspaceId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void releaseHold(@ActingWorkspace UUID workspaceId,
    ...
    public List<UUID> dueForErasure(@ActingWorkspace UUID workspaceId,
                                    @RequestParam(required = false)
