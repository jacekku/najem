...
dependencies {
    ...
    // For the csrf() request post-processor. A test that forges the token by hand would be
    // asserting against our own idea of the token rather than against the filter's.
